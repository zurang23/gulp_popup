    ...
    const popupCommon = function() {
        ...
        let optionEvent = {
            ...
            prevPopupStyleDelete: (target, trigger) => {
                ...
                const targetPopupDepth = Number(document.querySelector(`.${popupOptions.wrapperClassName}[data-popup='${getPopupValue}']`).getAttribute('data-popup-depth'));
                if (trigger ===  'escKey') document.querySelector(`.${popupOptions.wrapperClassName}[data-popup-depth='${targetPopupDepth}']`).classList.remove(popupOptions.dimmedPrevClassName);
                else document.querySelector(`.${popupOptions.wrapperClassName}[data-popup-depth='${targetPopupDepth - 1}']`).classList.remove(popupOptions.dimmedPrevClassName);
            },
            // 팝업 dimmed 삭제
            dimmedeDelete: () => {
        ...
        let clickEvent = {
            ...
            openCommonEvent: (popupElement) => {
                ...
                let popupTitle = popupElement.querySelector(`.${popupOptions.titleClassName}`);
                popupTitle.focus();
            ...
            singleCloseCommonEvent: (popupElement, trigger) => {
                ...
                if (_popupVariable.focusElement.length > 0) {
                    ...
                    _popupVariable.KeyboardEventElement = document.querySelector(`.${popupOptions.wrapperClassName}[data-popup-depth='${_popupVariable.popupDepth}']`);
                };
                ...
                if (popupElement.getAttribute('data-popup-auto') === 'true') {
                    ...
                    if ($thisPopupDepth > 1) {
                        ...
                        _popupVariable.KeyboardEventElement = document.querySelector(`.${popupOptions.wrapperClassName}[data-popup-depth='${$thisPopupDepth - 1}']`);
                    } else {
                        document.body.setAttribute('tabindex', '0');
                        document.body.focus();
                    };
        ...
        let startPopup = {
            ...
            openStartPopup: (autoPopup) => {
                ...
                // 팝업 위 팝업이 뜰 경우 이전 팝업 opacity (dimmed 옵션 true 일 경우 동작, default : true)
                if (popupOptions.dimmed && _popupVariable.popupDepth > 1) _popupVariable.autoPopups[_popupVariable.popupDepth - 2].classList.add(popupOptions.dimmedPrevClassName);
            },
            // 쿠키 값 확인
            getCookie: () => {
